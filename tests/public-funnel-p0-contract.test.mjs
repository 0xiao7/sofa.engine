...
test('homepage and free entry send candidates directly into a no-login practice surface', () => {
  assert.match(index, /class="hero-trial" href="quiz\.html\?free=1&start=1&session=1&count=5&utm_source=site&utm_medium=hero&utm_campaign=free_quiz_entry"/);
  assert.match(index, /href="quiz\.html\?free=1&start=1&session=1&count=5&utm_source=home&utm_medium=plan_card&utm_campaign=home_free_quiz_entry"/);
